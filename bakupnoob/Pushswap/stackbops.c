...
/*   Updated: 2023/03/26 22:00:03 by dgarizad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @param stack 
 * @param flag 1 for ascending (stacka) 2 fir descending (stack_b)
 */
int	ft_sort_two(t_list **stack, int flag)
{
	if (flag == 1)
		if ((*stack)->num > (*stack)->next->num)
			ft_swap(&(*stack), NULL, 1);
	if (flag == 2)
		if ((*stack)->num < (*stack)->next->num)
			ft_swap(&(*stack), NULL, 2);
	return (0);
}
